setClassUnion("vector_or_null", c("vector", "NULL"))
...
setClass(
    "MldpEHR",
    representation(patients = "list", features = "list", age_groups = "vector_or_null")
)
...
#'     tibble::tibble(
#'         id = 1:10,
#'         age = sample(80:85, 10, replace = TRUE),
...
#'     tibble::tibble(
#'         id = 11:20,
#'         age = sample(75:80, 10, replace = TRUE),
#'         sex = sample(1:2, 10, replace = TRUE),
#'         followup = sample(0:5, 10, replace = TRUE),
